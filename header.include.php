<html>
    <head>
        ...
        <script type="text/javascript" src="js/script_componentes.js"></script>
        <script type="text/javascript" src="js/script_automovel.js"></script>
    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="#">Automóveis</a>
